...
final MethodChannel _channel = const MethodChannel('cn.fb/flutter_social')
...
Future authByQRCode({@required String appId,
...
/// open mini-program
/// see [WeChatMiniProgramType]
Future launchMiniProgram({
  @required String username,
  String path,
  WeChatMiniProgramType miniProgramType = WeChatMiniProgramType.RELEASE,
}) async {
...
const Map<Type, String> _shareModelMethodMapper = {
  ...
  WeChatShareImageDataModel: "shareImage",

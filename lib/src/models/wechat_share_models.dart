...
const String _thumbnailData = "thumbnailData";
...
class WeChatShareTextModel extends WeChatShareModel {
  ...
  Map toMap() {
    return {
      ...
      _scene: weChatSceneToString(scene),
...
class WeChatShareMiniProgramModel extends WeChatShareModel {
  final String webPageUrl;
  final WeChatMiniProgramType miniProgramType;
  final String userName;
  final String path;
  ...
  WeChatShareMiniProgramModel({
    @required this.webPageUrl,
    WeChatMiniProgramType miniProgramType,
    this.userName,
    this.path: "/",
    this.title,
    this.description,
    ...
    String mediaTagName,
        ...
        this.miniProgramType = miniProgramType ?? WeChatMiniProgramType.RELEASE,
        assert(webPageUrl != null && webPageUrl.isNotEmpty),
        assert(userName != null && userName.isNotEmpty),
        assert(path != null && path.isNotEmpty),
        super(
  ...
  Map toMap() {
    return {
      'webPageUrl': webPageUrl,
      "miniProgramType": miniProgramTypeToString(miniProgramType),
      "userName": userName,
      "path": path,
      "title": title,
      "description": description,
...
///[image] can't be null.
///if [thumbnail] is null or blank,fluwx will create a thumbnail through [image]
class WeChatShareImageDataModel extends WeChatShareModel {
  final String transaction;
